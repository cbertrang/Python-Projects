...
#Function to display the moves available.
def attack_list():
...
#While loop that prompts the hero to attack the monster until either of their HP's is below or equal to 0. If a number between 1-4 is not selected, the turn is passed.
